...
async fn ai_book_v3_value_save_round_trips() {
    ...
    assert_eq!(
        loaded.catchup_stats.as_ref().unwrap().last_chapter_index,
        Some(7)
    );
